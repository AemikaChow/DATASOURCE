...
*****
**Fashionista 2012**: **158,235** fashion photos with associated text annotations (tags, comments, and links).  The tags are noisy or incomplete. **685** photos with good visibility of the full-body with pose annotations for the usual 14 body parts. Meanwhile, there are totally **56** labels (**53** category or sub-category labels, and additional labels for hair, skin, and null (background).  
